...
export const TabBar = ({ activeTab, onTabChange, todayCount, collectionCount }: TabBarProps) => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-30 flex items-start justify-around"
      style={{
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className="relative flex flex-col items-center justify-center gap-0.5 flex-1 focus:outline-none"
            style={{
              height: '64px',
              paddingTop: '8px',
              paddingBottom: '8px',
